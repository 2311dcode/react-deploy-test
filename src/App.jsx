...
/*
	...
	- module.scss는 아니지만 컴포넌트의 효율적인 유지보수를 위해서 폴더별로 jsx, scss파일을 그룹화하다보니 일반 미디어쿼리로 반응형처리하기에는 반복작업과 css변수활용에 어려움이 있어서 useMedia라는 커스텀훅을 직접 만들어서 스크립트로 반응형 스타일링되도록 처리(useMedia 가이드 p.100)
	...
	해결절차
- Flickr만 리덕스에서 제외하고 고민하던중에 비동기데이터 전역State 처리를 위한 redux-saga를 알게되고 saga버전으로 작업을 진행했다
*/
