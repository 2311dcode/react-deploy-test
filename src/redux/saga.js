...
*/
/* 
순서1 - 초기 액션 타입을 인지해서 패칭관련 메서드 대신 호출해주는 함수 정의 
순서2 - 데이터 패칭후 비동기 데이터 상태에 따라 액션객체를 만들어 리듀서로 전달하는 함수 정의 
순서3- saga메서드를 비동기적으로 호출해주는 함수 정의후 rootsaga라는 이름으로 export (추후 미들웨어로 reducer에 적용됨)
*/
