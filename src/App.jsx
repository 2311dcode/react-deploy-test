...
/*
	...
	: 쿼리키를 통해서 특정 fetching된 promise 리턴값을 매핑해서 서버요청시 동일한 쿼리키에 이미 매핑된 데이터가 있으면 refetchig하지 않음
	: 쿼리키로 초기 데이터 매핑시 cahceTime(GC Time), staleTime을 지정해서 서버데이터의 캐시저장 시간 및 refetching금지 시간 지정
	react-query 작업순서
